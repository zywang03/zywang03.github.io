...
<p>My research interests focus on <strong>robot learning</strong> and <strong>robotic foundation models</strong>, especially post-training for robotic foundation models and real-world robot learning systems.</p>
...
<p class="updates-label"><strong>Recent updates:</strong></p>
<ul>
  <li><span class="date-tag">2026.05</span> Two papers accepted by ICML 2026.</li>
  <li><span class="date-tag">2025.06</span> I graduate from <span class="school-entry"><img class="school-logo" src="./assets/img/whut-logo.svg" alt="" aria-hidden="true">WHUT</span> as an outstanding graduate.</li>
</ul>
</div>
...
<ul>
  <li><span class="date-tag">2025.06</span> <strong>Distinguished Undergraduate Thesis (Top 3%) / Outstanding Graduate</strong>, <span class="school-entry"><img class="school-logo" src="./assets/img/whut-logo.svg" alt="" aria-hidden="true">WHUT</span></li>
  <li><span class="date-tag">2024.11</span> <strong>National Scholarship</strong>, Chinese Ministry of Education, China</li>
  <li><span class="date-tag">2023.09</span> <strong>National First Prize</strong>, China Undergraduate Mathematical Contest in Modeling (CUMCM), China Society for Industrial and Applied Mathematics <a href="/assets/files/2023CUMCM.pdf" target="_blank">pdf</a></li>
</ul>
